<?php
# Usage: php extensions/FontAwesome/tests/setup/fix-composer.php mediawiki/font-awesome dev-master g/cmln/mw-font-awesome < composer.local.json-sample > composer.local.json
#
